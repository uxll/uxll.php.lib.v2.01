...
class vdimgck extends CController{
	private $config = array(
		...
		'img_width'   => 68,
		'use_boder'   => TRUE,
		'font_file'   => 'uxll/models/vdimgck/ggbi.ttf',
		'wordlist_file'   => 'uxll/models/vdimgck/words.txt',
		'filter_type' => 5
	);

	public function __construct(){
		if (!$this  -> v($this -> config)){
		    S('securimage_code_value',strtolower('abcd'));
		    $im = @imagecreatefromjpeg( ROOT.'models/vdimgck/vdcode.jpg');
	...
	public function v( $config = array() ){
	    ...
	    S('securimage_code_value',strtolower($rndstring));
